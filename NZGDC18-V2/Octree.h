...
namespace brandonpelfrey {
	...
	class Octree {
		...
		void getPointsInsideRadiusSqr(const Vec4& source, double radius_sqr, std::vector<Vec4>& results)
		{
			getPointsInsideRadiusSqrImpl(this, source, radius_sqr, results);
		}

		static void getPointsInsideRadiusSqrImpl(Octree* root, const Vec4& source, double radius_sqr, std::vector<Vec4>& results)
		{
			Octree* tail = root;
